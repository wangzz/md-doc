# 认识汉字订阅条款 / KnowWord Subscription Terms
...
本《订阅条款》适用于您在认识汉字（以下简称"本应用"）中购买的订阅服务，是《用户协议》的补充协议。如本条款与《用户协议》冲突，以本条款为准。
...
**iOS 设置 → 您的 Apple ID 头像 → 订阅 → 选择认识汉字 → 取消订阅**
...
These Subscription Terms apply to subscription services you purchase within KnowWord (the "App") and supplement the Terms of Use. In case of conflict, these Subscription Terms prevail.
...
|---|---|---|
| Monthly Subscription | Auto-Renewable | ¥6/month |
| Yearly Subscription | Auto-Renewable | ¥48/year |
| Lifetime Purchase | Non-Consumable | ¥128 (one-time) |
...
2.4 **Free Trial**: No free trial is offered for this App.

### 3. Managing Your Subscription

You can manage or cancel your subscription any time at:

**iOS Settings → Your Apple ID avatar → Subscriptions → Select KnowWord → Cancel**
