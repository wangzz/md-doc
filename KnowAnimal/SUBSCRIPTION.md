...
KnowAnimal 提供以下三种付费方式解锁全部 200 种动物与全部游戏功能：
...
- 在您确认购买并完成付款后，付款将通过您的 Apple ID 账户扣除
- 终身买断为一次性付费，无后续扣款
- 月度订阅与年度订阅在每个订阅周期开始时自动续费

### 三、自动续费

- 除非在当前订阅周期到期前 **至少 24 小时** 关闭自动续费，否则订阅会自动续费
...
- 苹果可能根据您所在地区的汇率与税率自动调整本地化价格
- 我们调整订阅价格时，已订阅用户在当前订阅周期内不受影响；下一周期续费前，苹果会通过推送通知告知，您可选择继续续费或取消

### 九、隐私

订阅状态通过苹果 StoreKit 接口在本地校验，不会上报至我们的任何服务器。详见 [隐私政策](./privacy.md)。
...
KnowAnimal offers three options to unlock all 200 animals and all games:
...
- Lifetime is a one-time purchase with no further charges
- Monthly and Yearly subscriptions auto-renew at the start of each billing period
