...
本目录存放 血压记录（BPHealth）的全部用户协议与隐私政策文件。App 通过 `LegalLinks` 常量引用这些文档的 GitHub Blob URL。

- 开发者：wangzz
- 联系邮箱：wzzvictory_tjsd@163.com
- 生效日期：2026-08-21
- 工程英文名（远端目录名）：`BPHealth`

## 文档清单

- [PRIVACY.md](./PRIVACY.md) — 隐私政策
- [TERMS.md](./TERMS.md) — 用户协议（使用条款）
- [SUBSCRIPTION.md](./SUBSCRIPTION.md) — 订阅条款
- [HEALTH.md](./HEALTH.md) — 健康数据说明（HealthKit Usage Disclosure）

## 访问 URL（GitHub Blob，App 内引用与 ASC 提交的唯一规范）

```
https://github.com/wangzz/md-doc/blob/main/BPHealth/<DOCNAME>.md
```
...
- `HEALTH.md` — 健康数据说明（HealthKit 启用时推荐）
