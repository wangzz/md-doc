...
本《订阅条款》适用于您在 到点吃药（以下简称"本应用"）中购买的订阅服务，是《用户协议》的补充协议。如本条款与《用户协议》冲突，以本条款为准。
...
**iOS 设置 → 您的 Apple ID 头像 → 订阅 → 选择 到点吃药 → 取消订阅**
...
7.1 永久解锁为一次性买断商品（非消耗型内购），单次支付 ¥48 后永久解锁本应用全部付费功能，不产生任何后续自动扣费。

7.2 永久解锁不属于自动续期订阅，不存在续期与取消问题。如您需要退款，同样需通过 Apple 申请（https://reportaproblem.apple.com）。

7.3 永久解锁同样绑定您的 Apple ID。如您更换设备或重新安装本应用，可在付费页通过「恢复购买」免费重新激活。
...
These Subscription Terms apply to subscription services you purchase within DoseOnTime (the "App") and supplement the Terms of Use. In case of conflict, these Subscription Terms prevail.

### 1. Subscription Products

The App offers the following paid products:

- **Monthly Membership**: ¥12 / month, auto-renewable subscription
- **Yearly Membership**: ¥28 / year, auto-renewable subscription
- **Lifetime Unlock**: ¥48, one-time purchase, valid forever (non-subscription; see Section 7)
...
**iOS Settings → Your Apple ID avatar → Subscriptions → Select DoseOnTime → Cancel**
...
### 7. Lifetime Unlock (One-Time Purchase)

7.1 Lifetime Unlock is a one-time, non-consumable in-app purchase. A single payment of ¥48 permanently unlocks all paid features of the App, with no subsequent automatic charges.

7.2 Lifetime Unlock is not an auto-renewable subscription; there is no renewal or cancellation involved. For refunds, you must likewise apply through Apple (https://reportaproblem.apple.com).

7.3 Lifetime Unlock is also bound to your Apple ID. If you change devices or reinstall the App, you can reactivate it for free via "Restore Purchase" on the paywall.
...
If you have questions about these Subscription Terms, please contact:
