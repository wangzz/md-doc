...
本《订阅条款》适用于您在 拼长图（以下简称"本应用"）中购买的订阅服务，是《用户协议》的补充协议。如本条款与《用户协议》冲突，以本条款为准。

### 1. 订阅产品

本应用提供以下付费商品（自 V1.1 起开售；V1.0 期间全部功能免费，付费墙仅展示定价）：

- 月订阅：¥12/月（自动续期）
- 年订阅：¥28/年（自动续期，新订阅用户享 3 天免费试用）
- 买断：¥68（一次性买断，非订阅商品）
...
2.4 **免费试用**：年订阅提供 3 天免费试用（仅限新订阅用户）。试用期结束后将自动转入付费订阅，除非您在试用期结束前至少 24 小时取消。

### 3. 如何管理订阅

您可以随时在以下位置管理或取消订阅：

**iOS 设置 → 您的 Apple ID 头像 → 订阅 → 选择 拼长图 → 取消订阅**
...
6.1 订阅绑定您的 Apple ID，而非应用内账号（本应用无账号体系）。同一 Apple ID 在多台设备上登录可共享订阅权益。
...
These Subscription Terms apply to subscription services you purchase within 拼长图 (the "App") and supplement the Terms of Use. In case of conflict, these Subscription Terms prevail.

### 1. Subscription Products

The App offers the following paid products (available starting from V1.1; during V1.0 all features are free and the paywall displays pricing only):

- Monthly Subscription: ¥12/month (auto-renewable)
- Yearly Subscription: ¥28/year (auto-renewable, 3-day free trial for new subscribers)
- Lifetime: ¥68 (one-time purchase, non-subscription)
...
2.4 **Free Trial**: The yearly subscription includes a 3-day free trial (new subscribers only). The trial automatically converts to a paid subscription at its end unless you cancel at least 24 hours before the trial ends.

### 3. Managing Your Subscription

You can manage or cancel your subscription any time at:

**iOS Settings → Your Apple ID avatar → Subscriptions → Select 拼长图 → Cancel**
...
6.1 Subscriptions are bound to your Apple ID rather than an in-app account (the App has no account system). The same Apple ID across multiple devices shares the subscription.
